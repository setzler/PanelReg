...
test_that("Estimation with covariates, AR1 known rho", {
    # simulate example data
    simulated_data = PanelRegSim(sample_size = 20000, min_year = 2001, max_year = 2010, true_beta = c(0.5, -0.2), true_gamma = c(1, -1), panel_model = "AR1", return_unobservables = FALSE)
